...
document.addEventListener('DOMContentLoaded', function () {
    ...
    calculateBtn.addEventListener('click', function() {
        ...
        resultsDiv.innerHTML = `
            ...
            <div class="two-col-layout" style="text-align: left; gap: 2rem; align-items: stretch; margin-bottom: 1.5rem;">
                <div style="background-color: var(--bg-accent); padding: 1.5rem; border-radius: 8px;">
                    <h4 data-lang-key="insurance_calc_h4_1" style="margin-top:0;">1. Your "Savings" Insurance Policy</h4>
                ...
                <div style="background-color: var(--bg-accent); padding: 1.5rem; border-radius: 8px;">
                    <h4 data-lang-key="insurance_calc_h4_2" style="margin-top:0;">2. A Smarter Investment Plan</h4>
        ...
        if(window.setLanguage) {
            ...
            resultsDiv.querySelectorAll('[data-lang-key]').forEach(element => {
                const key = element.getAttribute('data-lang-key');
                if(currentLang === 'ja' && translations.ja[key]) {
